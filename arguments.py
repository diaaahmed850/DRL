...
def get_args():
    ...
    parser.add_argument('--action', default='train',
                        help='algorithm to use: train | test | plot')
    parser.add_argument('--algo', default='a2c',
                        help='algorithm to use: dqn | acktr | a2c')
    parser.add_argument('--train-type', default='screenshots',
    ...
    parser.add_argument('--env-name', default='citycopter-v0',
                        help='environment to train on (default: PongNoFrameskip-v4)')
    parser.add_argument('--log-dir', default='plots/',
